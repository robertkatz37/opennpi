...
app.get("/", async (req, res) => {
  try {
    ...
    // Build HTML
    let html = `<html><head><title>Providers</title>
      <style>
    ...
    if (providerDetailRows.length) {
      ...
      html += `<table id="provider-details-table"><tr>
        <th>#</th><th>Provider Name</th><th>Address</th><th>Taxonomy</th><th>Enumeration Date</th>
      </tr>`;
...
app.get("/provider-details", async (req, res) => {
  try {
    ...
    let html = `<html><head><title>Provider Details</title>
      <style>
        body { font-family: Arial, sans-serif; margin: 20px; }
      ...
      <table id="provider-details-table"><tr>
        <th>#</th><th>Provider Name</th><th>Address</th><th>Taxonomy</th><th>Enumeration Date</th>
      </tr>`;
